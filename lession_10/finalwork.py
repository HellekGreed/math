...
print('Даны значения роста в трех группах случайно выбранных спортсменов:')
print('Футболисты: 173, 175, 180, 178, 177, 185, 183, 182.')
print('Хоккеисты: 177, 179, 180, 188, 177, 172, 171, 184, 180.')
print('Штангисты: 172, 173, 169, 177, 166, 180, 178, 177, 172, 166, 170.')
print()
...
print()
print(f'S^2({S2:.2f}) = Sf^2({S2_F}) + Sres^2({S2_res:.2f})')
...
print()
print(f'Так как T > F_crit делаем вывод, что отличие среднего роста спортсменов является статистически значимым')
